...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 23 Avril 2017 à 02:51
...
CREATE TABLE `chaussures` (
  ...
  `promotion` int(11) NOT NULL COMMENT 'chaussures en promotion'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `client` (`id`, `pseudo`, `courriel`, `mot_de_passe`) VALUES
(1, 'Maria', 'maria@hotmail.com', 12345),
(2, 'Marco', 'marco@hotmail.com', 12345),
(3, 'Taylor', 'taylor@hotmail.com', 12345),
(4, 'Bruno', 'bruno@hotmail.com', 12345);
